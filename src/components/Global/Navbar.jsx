...
import authSlice, { clearUser } from "./../../store/signup";
...
function Navbar() {
  ...
  return (
    ...
    >
      <div className={`flex  py-2 ${userData.email ? "justify-between":"justify-center "} items-center`}>
        <div className="items-center md:px-10 px-7">
          <span className="mr-1 pt-1 flex  items-center">
            <div className={`${userData.email ? "":"w-full justify-center items-center"}`}>
              <div className="logo flex items-center md:pl-10 px-7">
                <span className="mr-1 pt-1 flex  items-center">
                  <Link to="/">
                    {" "}
                    <img
                      src={color ? LogoWhite : Logo}
                      className={`${userData.email ? "w-28":"w-[10rem]"} `}
                      alt=""
                    />
                  </Link>
                </span>
        ...
        <div className="items-center px-7 flex  max-md:mr-[50px]">
          <div className={`flex ${userData.email ? "":"hidden"}`}>
            <i
              onClick={() => {
                setfavBar(!favBar);
                console.log(favBar);
              }}
              className="fa-solid fa-heart text-[25px] text-[red]"
            ></i>
            <i
            ...
            <Link
              ...
              className="fa-solid fa-arrow-right-to-bracket text-[25px] ml-2"
            ></Link>
          </div>
        </div>
        ...
        <div
          className={`sidebar transform ${
            siderBar ? "" : "hidden translate-x-full"
          }  h-[100vh] overflow-y-scroll overflow-x-hidden  max-md:w-[70vw]  w-[30vw] bg-cover bg-no-repeat bg-center bg-opacity-50 z-50 absolute top-0 right-0   `}
          style={{
        ...
        <div
          className={`sidebar transform ${
            favBar ? "" : "hidden translate-x-full"
          }  h-[100vh] overflow-y-scroll overflow-x-hidden  max-md:w-[70vw]  w-[30vw] bg-cover bg-no-repeat bg-center bg-opacity-50 z-50 absolute top-0 right-0   `}
          style={{
            backgroundImage: `url(${bgSideBar})`,
            transition: "transform 0.3s ease-in-out",
        ...
        >
          ...
          <h1 className="text-center uppercase mt-2 font-[700]">
    ...
    <p className="text-[20px font-bold]">
      ...
      <div className={` ${userData.email ? "":"hidden"} category flex justify-center items-center`}>
        <ul
      ...
      <div
        ...
        className= {`${userData.email ? "absolute right-[5%] top-[30%] cursor-pointer z-20 md:hidden ":"hidden"} `}
      >

...
import { clearUser, signInUser, signInWithGoogle } from "../../store/signup";
...
function Login() {
  ...
  const [errorDeatils, setError] = useState(null);
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      dispatch(signInUser({ email, password })); // <== dispatch the signupUser async thunk
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      await dispatch(signInWithGoogle({ email: user.email, password: token }));
          ...
          <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
            <div className="w-full text-center mb-3 ">
              <h2 className="font-[700] text-lg">
                Login <i className="fa-solid fa-arrow-turn-down"></i>
              </h2>
            </div>
...
<button
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                >
                  Create New Account <i className="fa-solid fa-arrow-right"></i>
                </a>
              </div>
